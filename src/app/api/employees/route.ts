...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('[API] Unexpected error in employees GET:', error);
    return NextResponse.json(
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('[API] Unexpected error in employees POST:', error);
    return NextResponse.json(
      { success: false, error: 'Internal Server Error' },
      { status: 500 }
    );
...
export async function PUT(req: NextRequest) {
  try {
    ...
    console.error('[API] Unexpected error in employees PUT:', error);
    return NextResponse.json(
      { success: false, error: 'Internal Server Error' },
      { status: 500 }
    );
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error('[API] Unexpected error in employees DELETE:', error);
    return NextResponse.json(
      { success: false, error: 'Internal Server Error' },
      { status: 500 }
    );
